class Solution {
    public int rob(int[] nums) {
        // Handle base case for empty or single element array
        ...
        // Renamed the helper method to avoid ambiguous recursion
    ...
    // Changed name to robHelper to fix the logic and syntax conflict
